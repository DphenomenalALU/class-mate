      ...
      <Card>
        ...
        <CardContent className="space-y-3 text-sm text-muted-foreground">
          <ul className="list-disc list-inside space-y-1">
            <li>
              <span className="font-medium text-foreground">Sign in</span> with your institutional Google account from
              the login page.
            </li>
            <li>
              Go to <span className="font-medium text-foreground">My Dashboard</span> to see your courses and start a
              session.
            </li>
            <li>
            ...
            <li>
              When you escalate, you can add a short note. Your facilitator receives an email and a log entry in their
              dashboard.
            </li>
            <li>
      ...
      <Card>
        ...
        <CardContent className="space-y-3 text-sm text-muted-foreground">
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>
              Create an assistant from the <span className="font-medium text-foreground">Assistants</span> page for each
              course you teach. Each assistant has its own persona and Tavus replica.
            </li>
            <li>
            ...
            <li>
              Share the assistant link (copied from the assistant card) with students. They&apos;ll be queued if someone
              else is already in a session.
            </li>
            <li>
